  ...
  <aside class="col-lg-4 sidebar-home"> 
    ...
    <!-- Promotion -->
    <div class="promotion">
      <img src="{{asset('usr_assets/images/tomato.jpg')}}" class="img-fluid w-100">
      <div class="promotion-content">
        ...
        <!-- <p class="text-white mb-4">Lorem ipsum dolor sit amet, consectetur sociis. Etiam nunc amet id dignissim. Feugiat id tempor vel sit ornare turpis posuere.</p>
         -->
        <button type="button" class="btn btn-primaru" onclick="verify()" style="background-color: red";padding-right: 34.507;padding-left: 43px;margin-top: 565px;>Predict Image</button>
      </div>
    </div>
  ...
  <script>
    function verify() {
            window.location.href =
                'http://localhost/TLDDF/tld/tensorflowModels.html';
