...
<div class="vidoe" style="padding-left:450px; padding-right: 700px;">
    <iframe width="500" height="300" src="https://www.youtube.com/embed/KZeEHYn5I0g"
          title="YouTube video player" frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
          allowfullscreen>
          </iframe>
    <!-- <iframe width="380" height="215" src="https://www.youtube.com/embed/gjMIh19zH7k"
          title="YouTube video player" frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
          allowfullscreen>
          </iframe> -->
    ...
    <div class="container">
        ...
        <div class="col-md-5 text-center text-md-left mb-1">
        ...
        <div class="col-md-5 text-md-right text-center mb-1">
            <ul class="list-inline footer-list mb-0">
